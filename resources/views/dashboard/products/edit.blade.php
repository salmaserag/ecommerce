    ...
    <section class="section dashboard">
        ...
        <div class="container w-75">
            <div class="card">
                ...
                <form id="form" action="{{ route('products.update', ['product' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                <div class="form-floating">
                                    ...
                                    <x-form.input value="{{ $product ? $product->name : old('name') }}" label="Product Name" id="name"
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-floating">
                                    ...
                                    <x-form.input value="{{$product ? $product->code : old('code') }}" label="Code" id="code"
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-floating">
                                    ...
                                    <x-form.input value="{{$product ? $product->marka : old('marka') }}" label="Marka" id="marka"
                            ...
                            <div class="mb-3 col-4">
                                <div class="mb-3 col-12">
                                    <div class="form-floating">
                                        ...
                                        <x-form.input value="{{$product ? $product->price : old('price') }}" label="Price" id="price"
                            ...
                            <div class="mb-3 col-4">
                                <div class="mb-3 col-12">
                                    <div class="form-floating">
                                        ...
                                        <x-form.input value="{{$product ? $product->quantity : old('quantity') }}" label="Quantity" id="quantity"
                                ...
                                <div class="mb-3 col-12">
                                    <div class="form-floating">
                                        ...
                                        <x-form.texterea type="text" name="description" id="description" placeholder="Description"
                                            value="{{$product ? $product->description : old('description') }}" for="description" label="Description" />
