                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 col-12">
                            <div class="form-floating">
                                ...
                                <x-form.input value="{{ $category ? $category->name : old('name') }}" label="Category Name" id="name"
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-floating">
                                ...
                                <x-form.texterea type="text" name="description" id="description"
                                    placeholder="Description" value="{{ $category ? $category->description : old('description') }}" for="description"
                                    label="Description" />
