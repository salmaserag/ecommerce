                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-floating">
                                    ...
                                    <x-form.input value="" label="Password" id="floatingPassword" name="password"
                                        placeholder="Password" type="password" for="floatingPassword" />
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-floating">
                                    ...
                                    <x-form.input value="" label="Password_Confirmation" id="floatingPassword"
