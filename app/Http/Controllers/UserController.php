...
class UserController extends Controller
{
    ...
    {
        $roles = Role::select('id', 'name')->where('guard_name','web')->get();         //to show roles is selection
    ...
    {
        $roles = Role::select('id', 'name')->where('guard_name','web')->get();                       //get from table role "id , name"
